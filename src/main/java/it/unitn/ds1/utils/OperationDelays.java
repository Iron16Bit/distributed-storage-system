...
public class OperationDelays {
    ...
    public static final int CLIENT_GET_DELAY = (int)(BASE_DELAY * 6.0) + 500;     // Includes quorum read + response + client timeout
    public static final int CLIENT_UPDATE_DELAY = (int)(BASE_DELAY * 7.0) + 500;  // Includes read-before-write + quorum write + client timeout
