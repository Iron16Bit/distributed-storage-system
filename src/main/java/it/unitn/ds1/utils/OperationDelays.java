...
public class OperationDelays {
    ...
    public static final int CLIENT_UPDATE_DELAY = (int)(BASE_DELAY * 3.5);  // Includes read-before-write + quorum write
    ...
    public static final int LEAVE_DELAY = (int)(BASE_DELAY * 1.2);          // Complete leave process with data redistribution
