...
public class TimeoutDelay {
    ...
    public static final int CLIENT_GET_DELAY = (int)(BASE_DELAY * 4.2);     // Includes quorum read + response
    public static final int CLIENT_UPDATE_DELAY = (int)(BASE_DELAY * 4.2);  // Includes read-before-write + quorum write
